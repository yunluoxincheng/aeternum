...
### Requirement: MainScreen 扩展

系统 SHALL 扩展现有的 `MainScreen.kt` 以支持完整的状态机流程。
...
**Reason**: 生物识别更安全、更便捷，符合 Class 3 安全要求。

**Migration**: 用户首次设置时仍需要设置主密码，但日常使用仅需生物识别。
