...
**Capability ID**: `pqrr-state-machine`
**Version**: 1.0
**Status**: Proposed
...
- 依赖: `storage::aug::*` - 原子纪元升级协议
- 依赖: `models::epoch::CryptoEpoch` - 纪元类型
- 依赖: `models::device::DeviceHeader` - 设备 Header
- 被依赖: `recovery-protocol` - 恢复协议使用状态机转换
